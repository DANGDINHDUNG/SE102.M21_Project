...
void TXT::LoadAllTexture()
{
	...
	listTexture[TMEGAMANSTAGE] = new MyTexture((char*)"SourceImage\\Marco.png", D3DCOLOR_XRGB(255, 0, 255));
	...
	listTexture[THEADGUNNERCUSTOMER] = new MyTexture((char*)"SourceImage\\Soldier.png", D3DCOLOR_XRGB(255, 255, 255));

	//===============================HELIT SPRITE=====================================
	listTexture[THELIT] = new MyTexture((char*)"SourceImage\\helit.png", D3DCOLOR_XRGB(255, 255, 255));

	//===============================NOTORBANGER SPRITE=====================================
	listTexture[TNOTORBANGER] = new MyTexture((char*)"SourceImage\\Grab.png", D3DCOLOR_XRGB(255, 255, 255));
	...
	listTexture[TITEM] = new MyTexture((char*)"SourceImage\\item.png", D3DCOLOR_XRGB(255, 255, 255));
	listTexture[TTEST] = new MyTexture((char*)"SourceImage\\megamanstage.png", D3DCOLOR_XRGB(50, 96, 166));
}
