...
#define MAIN_WINDOW_TITLE L"METAL SLUG III"
...
void CSampleKeyHander::OnKeyDown(int KeyCode)
{
	...
	case DIK_A: // reset
		...
		character->SetPosition(50.0f,0.0f);
...
void LoadResources()
{
	...
	textures->Add(ID_TEX_MISC, L"textures\\msc.png", D3DCOLOR_XRGB(176, 224, 248));
	textures->Add(ID_TEX_MAP, L"textures\\misson1.png", D3DCOLOR_XRGB(248, 0, 248));
	...
	textures->Add(ID_TEX_TANK, L"textures\\idle.png", D3DCOLOR_XRGB(255, 255, 255));
	...
	sprites->Add(20002, 0, 0, 2375,274, texMap);
	sprites->Add(20003, 2, 277, 707, 325, texMap);
	sprites->Add(20004, 1, 1186, 1610, 1417, texMap);

	LPDIRECT3DTEXTURE9 texTank = textures->Get(ID_TEX_TANK);
	sprites->Add(90001, 0, 0, 71, 56, texTank);
	...
	map->SetPosition(-250, -80);
	objects.push_back(map);

	CBrick* gate = new CBrick();
	gate->AddAnimation(604);
	gate->SetPosition(-350, -30);
	...
	for (int i = -15; i < 150; i++)
	{
		CBrick* brick = new CBrick();
		brick->AddAnimation(601);
		brick->SetPosition(i * 16.0f, 195);
		objects.push_back(brick);
	}
	/*for (int i = 50; i < 200; i++)
	{
		//if (i == 75||i==74||i==80||i==81||i==91||i==92||i==97) continue;
		CBrick* brick = new CBrick();
		brick->AddAnimation(601);
		brick->SetPosition(i * 16.0f, 255);
		objects.push_back(brick);
	}*/
	/*for (int i = 5; i < 10; i++)
	{
	...
	for (int i = 0; i < 2; i++)
	{
		...
		Solider->SetPosition(200 + i*70, 155);
